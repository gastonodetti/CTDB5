...
public class OdontologoDaoH2Test {
    ...
    @Test
    public void test07ActualizarExistente() throws Exception {
        Boolean seActualizo = odontologoDaoH2.actualizar(new Odontologo("2", "Pipo", "Pipardito", "332211"));
        assertTrue(seActualizo);
    }
